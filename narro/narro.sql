...
CREATE TABLE narro_project_setting_type (
  project_setting_type_id int(10) unsigned NOT NULL auto_increment,
  project_setting_type varchar(255) NOT NULL,
  PRIMARY KEY (project_setting_type_id),
  UNIQUE KEY project_setting_type (project_setting_type)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE narro_project_setting_value (
  project_setting_value_id int(10) unsigned NOT NULL auto_increment,
  project_id int(10) unsigned NOT NULL,
  language_id int(10) unsigned NOT NULL,
  project_setting_type_id int(10) unsigned NOT NULL,
  setting_value text NOT NULL,
  PRIMARY KEY (project_setting_value_id),
  UNIQUE KEY project_id_2 (project_id,language_id,project_setting_type_id),
  KEY project_id (project_id),
  KEY language_id (language_id),
  KEY project_setting_id (project_setting_type_id)
...
CREATE TABLE narro_suggestion (
  ...
  suggestion_char_count smallint(5) unsigned NOT NULL default '0',
  suggestion_word_count smallint(5) unsigned NOT NULL default '0',
...
CREATE TABLE narro_text (
  ...
  text_word_count smallint(5) unsigned NOT NULL default '0',
  has_comments tinyint(1) default '0',
  created timestamp NOT NULL default '0000-00-00 00:00:00',
  modified timestamp NOT NULL default '0000-00-00 00:00:00',
  PRIMARY KEY (text_id),
...
ALTER TABLE narro_project_setting_value
  ADD CONSTRAINT narro_project_setting_value_ibfk_1 FOREIGN KEY (project_id) REFERENCES narro_project (project_id),
  ADD CONSTRAINT narro_project_setting_value_ibfk_2 FOREIGN KEY (language_id) REFERENCES narro_language (language_id),
  ADD CONSTRAINT narro_project_setting_value_ibfk_3 FOREIGN KEY (project_setting_type_id) REFERENCES narro_project_setting_type (project_setting_type_id);
