<?php
	...
	abstract class NarroSuggestionCommentEditFormBase extends QForm {
		...
		/**
		 * @var NarroSuggestionCommentMetaControlGen mctNarroSuggestionComment
		 */
...
//		protected function Form_PreRender() {}
		...
		protected function Form_Create() {
			...
			$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('NarroSuggestionComment'))));
