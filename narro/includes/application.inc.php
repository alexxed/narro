<?php
    ...
    */
    ...
    define('__LOCALE_DIRECTORY__', __DOCROOT__ . __SUBDIRECTORY__ . '/locale/' . NarroApp::$Language->LanguageCode . '/LC_MESSAGES');
    if (!file_exists(__LOCALE_DIRECTORY__)) {
        if (!mkdir(__LOCALE_DIRECTORY__, 0777, true))
            ...
            NarroUtils::RecursiveChmod(__DOCROOT__ . __SUBDIRECTORY__ . '/locale/' . NarroApp::$Language->LanguageCode);
    }
