<?php
    ...
    class NarroRoleEditPanel extends QPanel {
        ...
        public function __construct($objParentObject, $objNarroRole = null, $strControlId = null) {
            ...
            $this->strTemplate = __DOCROOT__ . __SUBDIRECTORY__ . '/templates/NarroRoleEditPanel.tpl.php';
        ...
        public function btnSave_Click($strFormId, $strControlId, $strParameter) {
            if (NarroApp::HasPermissionForThisLang('Can manage roles', null)) {
                $this->UpdateNarroRoleFields();
                $this->objNarroRole->Save();
            }
            NarroApp::Redirect(NarroLink::RoleList());
        }
