<?php
    ...
    class NarroTopUsersPanel extends QPanel {
        ...
        public function __construct($objParentObject, $strControlId = null) {
            ...
            // Setup DataGrid
            $this->dtgUsers = new NarroDataGrid($this);
            ...
            $this->intLimit = floor(QApplication::$User->getPreferenceValueByName('Items per page') / 2);
        }
        ...
        protected function GetControlHtml() {
            $strCachedContent = QApplication::$Cache->load(__CLASS__ . '_' . QApplication::GetLanguageId());
            if ($strCachedContent === false) {
                $strCachedContent = $this->dtgUsers->Render(false);
                QApplication::$Cache->save($strCachedContent, __CLASS__ . '_' . QApplication::GetLanguageId(), array(), 3600);
            }
