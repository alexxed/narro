...
<?php } else
          echo sprintf(t('You can add suggestions if you are logged in. <a href="%s">Register</a> or <a href="%s">Log in</a> if you already have an account or an OpenId.'), 'join.php?l=' . QApplication::$TargetLanguage->LanguageCode, 'login.php?l=' . QApplication::$TargetLanguage->LanguageCode) . '<br /><br />';
?>
&nbsp;&nbsp;&nbsp;&nbsp;
