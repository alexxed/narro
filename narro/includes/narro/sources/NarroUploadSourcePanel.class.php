            ...
            switch(strtolower(pathinfo($this->fileSource->File, PATHINFO_EXTENSION))) {
                ...
                case 'xpi':
                    ...
                    if ($intErrCode === TRUE) {
                        ...
                        $objZipFile->close();
                        QApplication::$Logger->info(sprintf('Sucessfully uncompressed %s.', $this->fileSource->FileName));
                    } else {
                        switch($intErrCode) {
                ...
                case 'php':
                    ...
                    QApplication::$Logger->info(sprintf('Single file uploaded, copied %s to %s', $this->fileSource->FileName, $this->strWorkingDirectory));
                    break;
                default:
