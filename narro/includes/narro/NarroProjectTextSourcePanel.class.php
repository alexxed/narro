<?php
    ...
    class NarroUploadSourcePanel extends QPanel {
        ...
        public function __construct($objProject, $objParentObject, $strControlId = null) {
            ...
            $this->fileSource->FileAssetType = QFileAssetType::Archive;
    ...
    class NarroProjectTextSourcePanel extends QPanel {
        ...
        public function __construct($objProject, $objParentObject, $strControlId = null) {
            ...
            $this->pnlTextSource->UseAjax = NarroApp::$UseAjax;
            $objDirectoryPanel = new NarroDirectorySourcePanel($objProject, $this->pnlTextSource);
            $objDirectoryPanel->Directory = __DOCROOT__ . __SUBDIRECTORY__ . __IMPORT_PATH__ . '/' . $this->objProject->ProjectId . '/en-US';
    ...
    class NarroProjectTranslationSourcePanel extends QPanel {
        ...
        public function __construct($objProject, $objParentObject, $strControlId = null) {
            ...
            $this->pnlTranslationSource->UseAjax = NarroApp::$UseAjax;
            $objDirectoryPanel = new NarroDirectorySourcePanel($objProject, $this->pnlTranslationSource);
            $objDirectoryPanel->Directory = __DOCROOT__ . __SUBDIRECTORY__ . __IMPORT_PATH__ . '/' . $this->objProject->ProjectId . '/' . NarroApp::$Language->LanguageCode;
