<?php
    ...
    class NarroProjectEditPanel extends QPanel {
        ...
        public function __construct($objNarroProject, $objParentObject, $strControlId = null) {
            ...
            $this->strTemplate = __DOCROOT__ . __SUBDIRECTORY__ . '/templates/NarroProjectEditPanel.tpl.php';
        }
        ...
        public function btnSave_Click($strFormId, $strControlId, $strParameter) {
            ...
            if ($this->strTitleVerb == t('Add')) {
                NarroApp::Redirect(NarroLink::ProjectImport($this->objNarroProject->ProjectId));
            }
        }
        ...
        public function btnDelete_Click($strFormId, $strControlId, $strParameter) {
            if (!NarroApp::HasPermission('Can delete project', $this->objNarroProject->ProjectId))
                NarroApp::Redirect(NarroLink::ProjectList());
