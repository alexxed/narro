<?php
    ...
    class NarroSimilarSuggestionListPanel extends QPanel {
        ...
        public function __construct($objParentObject, $strControlId = null) {
            ...
            $this->dtgSuggestions->UseAjax = NarroApp::$UseAjax;
        ...
        public function dtgSuggestions_colSuggestion_Render($arrSuggestionData) {
            ...
            $strSuggestionValue = NarroApp::$PluginHandler->DisplaySuggestion($arrSuggestionData['suggestion_value']);
        ...
        public function dtgSuggestions_colText_Render($arrSuggestionData) {
            $strTextValue = NarroApp::$PluginHandler->DisplayText($arrSuggestionData['text_value']);
            if (!$strTextValue)
        ...
        public function dtgSuggestions_Bind() {
            ...
            if ($this->blnVisible) {
                try {
                    $arrSuggestions = NarroTextSuggestionIndexer::LoadSimilarSuggestionsByTextValue($this->objNarroText->TextValue, NarroApp::GetLanguageId(), $intLimit, $intOffset);
                }
