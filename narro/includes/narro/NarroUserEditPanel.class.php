<?php
    ...
    class NarroUserEditPanel extends QPanel {
        ...
        public function __construct($objNarroUser, $objParentObject, $strControlId = null) {
            ...
            $this->strTemplate = __DOCROOT__ . __SUBDIRECTORY__ . '/templates/NarroUserEditPanel.tpl.php';
        ...
        protected function btnDelete_Create() {
            ...
            $this->btnDelete->Display = NarroApp::HasPermission('Can manage users');
        }
        ...
        public function btnSave_Click($strFormId, $strControlId, $strParameter) {
            ...
            if ($this->objNarroUser->UserId == NarroApp::GetUserId()) {
