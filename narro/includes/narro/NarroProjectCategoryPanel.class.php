<?php
    ...
    class NarroProjectCategoryPanel extends QPanel {
        ...
        public function dtgProjectCategory_Bind() {
            $this->dtgProjectCategory->DataSource = NarroProjectCategory::LoadArrayByLanguageId(NarroApp::GetLanguageId());
