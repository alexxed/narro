<?php
    ...
    class NarroRoleListPanel extends QPanel {
        ...
        public function __construct($objParentObject, $strControlId = null) {
            ...
            $this->strTemplate = __DOCROOT__ . __SUBDIRECTORY__ . '/templates/NarroRoleListPanel.tpl.php';
            ...
            $this->dtgRole->ItemsPerPage = NarroApp::$User->getPreferenceValueByName('Items per page');

            // Specify Whether or Not to Refresh using Ajax
            $this->dtgRole->UseAjax = NarroApp::$UseAjax;
        ...
        public function dtgRole_Actions_Render(NarroRole $objNarroRole) {
            ...
            $btnEdit->Display = NarroApp::HasPermission('Can manage user roles');
            ...
            $btnDelete->Display = NarroApp::HasPermission('Can manage user roles');
