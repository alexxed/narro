<?php
    ...
    class NarroLanguageListPanel extends QPanel {
        ...
        public function __construct($objParentObject, $strControlId = null) {
            ...
            $this->strTemplate = __DOCROOT__ . __SUBDIRECTORY__ . '/templates/NarroLanguageListPanel.tpl.php';
            ...
            // Setup DataGrid
            $this->dtgLanguage = new QDataGrid($this);
            ...
            $this->dtgLanguage->ItemsPerPage = NarroApp::$User->getPreferenceValueByName('Items per page');
            ...
            if (NarroApp::HasPermission('Can edit language', null)) {
        ...
        public function dtgLanguage_ActiveColumn_Render(NarroLanguage $objLanguage) {
            if ($objLanguage->LanguageId == __SOURCE_LANGUAGE_ID__ || $objLanguage->LanguageId == NarroApp::GetLanguageId())
                return '';
        ...
        public function dtgLanguage_Actions_Render(NarroLanguage $objLanguage) {
            if (NarroApp::HasPermissionForThisLang('Can edit language', null))
                return sprintf('<a href="narro_language_edit.php?l=%s&lid=%d">%s</a>', NarroApp::$Language->LanguageCode, $objLanguage->LanguageId, t('Edit'));
        }
